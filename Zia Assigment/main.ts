...
let personCot = "The only thing we have to fear is fear itself. - "
console.log(personCot);
//5. Famous Quote 2: Repeat Exercise 4, but this time store the famous person’s name in a variable called famous_person. Then compose your message and store it in a new variable called message. Print your message.//
let famousPerson1 = 'Asif Zia';
let message1 = "The only thing we have to fear is fear itself. -";
...
let myName = "/n/t Asif Zia/t/n";
console.log(myName);
let myNameWithoutSpace = myName.trim();
...
let createMessage = "my favorite number is";
...
let friendName = ["Ali","Amir","Arham","Kiswa","Arshad"];
...
let friendName1 = ["Ali","Amir","Arham","Kiswa","Arshad"];
let message2 = "you are best friend"
...
let favoriteTransportation = ["Honda Cd 70","Honda 125","Suzaki 150","GD 110"];
let message3 = "I would like to own a"
...
//New guest
let gestArray :string[]= ["Asif","Ali","Hussen","Saad"];
//one person not attend dinner
let canNotCome = "Saad";
//Ask your new friend to join
let newFriendCome = "Arshad"
...
gestArray.map((item)=>console.log('Dear $(item) you are invite for dinner'));
...
of your program.*/
let gest_Array :string[]= ["Asif","Ali","Hussen","Saad"];
let middle_Gest="Sallam";
let middle_Index = gest_Array.length/2;
...
let placeToVesit = ["londen","spain","Ittly","Kashmir"];
...
let sortarray =["londen","spain","Ittly","Kashmir"];
sortarray.sort();
...
let cities:String[] = ["karachi","kashmir","Badin","Dadu","Sukker"];
...
let arrays:(String|number)[] =["Ali","Asad","wally",3,6,9];
...
let Favorit_fruit : string []= ["Apple","Orange","Mango"];
...
let users1:string[] =["Asif","Ali","Arshad","Shadid","Admin"];
...
let current_User: string [] =["Asif","Ali","Arshad","Shahid","Rahman"];

let new_users: string [] = ["sana","Asif","Kiswa","Ali","Sadia"];

new_users.forEach((new_user)=> {
      let new_userlower=new_user.toLowerCase();
      //use some() method
      let userNameTaken= current_User.some(current_User=>current_User.toLowerCase()=== new_userlower)

    if(userNameTaken){
        console.log(`${new_user}this username is available`);
    } else{
        console.log(`${new_user} the add member new`)
...
let pizzas:string[] =["Taka flaver","BBQ flaver","Mulli boti"]
...
function make_shirt(size:string, message:string) {
    console.log(`Making a ${size} t-shirt with a message "${message}" prented on it`)
...
let city1 =describe_city("Pakista","Karachi");
let city2 = describe_city("Pakistan","Hyderabad");
let city3 = describe_city("Pakistan","Dadu");
console.log(city1),
console.log(city2);
console.log(city3);
...
let my_city=city_country("Karachi","Pakistan")
...
function make_album(artest:string,Album_title:string){
    return {artest,Album_title}
}

let album1 = make_album("Ali Zuffer","Chnno ke ank");
let album2 = make_album("Arif Lohar","Jugni");
let album3 = make_album("shahzad roy","laga reh")
...
function make_album2(artest:string,Album_title:string,numberOfTrack:number){
    return {artest,Album_title,numberOfTrack}
}

let album4 = make_album2("Ali Zuffer","Chnno ke ank",4);
let album5 = make_album2("Arif Lohar","Jugni",12);
let album6 = make_album2("shahzad roy","laga reh",9)
...
function show_politetion(politics:string[]):void{
for(const politetion of politics){
    console.log(politetion.charAt(0).toUpperCase() +politetion.slice(1));
}
}
const politetion : string[] =["Nawaz Sharif","Zerdari","Imran Khan"]
...
let magician:string[] = ["Ali","Abbas","Akram"];
...
let magicianName =["Ali","Arshad","Abbas","Asif"]

let magicianNameCopy=[magicianName]
function show_magician(great:String){
    let withGreeting=" ";
    for(let item of magicianName){
withGreeting+=`${great} ${item}\n`;
    } return withGreeting;
};
let myGreatings = show_magician("Hallow");
...
function makeSand_wiches(item:string[]){
    console.log("\nMaking youer sandwich with:")
    item.forEach(element => console.log("-"+ element));
    console.log("enjoy your sandwich \n")
}

makeSand_wiches(["chachup","Cheese","lettuce"])
makeSand_wiches(["Beans","Mushroom","Cheese"])
makeSand_wiches(["Jelly","vegitable","Olive"])
...
function Car_Details(manufacturer:String,model:String ,...additionalInfo){
    let car={ manufacturer,model,...Object.fromEntries(additionalInfo)};

return car;
};
let myCarDetail= Car_Details("Toyta","Corlla",["colour","Blue"],["Year","2003"])
